# Digital Payments Churn Analysis using Survival Analysis

This repository contains the solution for the Ryt Bank Data Scientist Technical Assessment. The challenge is to analyze 6 months of customer data from a digital bank's payment product and develop a model to identify at-risk customers and understand churn drivers.
...
This project uses Python. The data files are included in the `/data` directory.
